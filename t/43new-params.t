...
like(
    exception { DateTime::Moment->new( year => 10.5 ) },
    qr/is an integer/,
...
like(
    exception { DateTime::Moment->new( year => 10, month => 2.5 ) },
    qr/an integer/,
    'month must be an integer'
);

like(
    exception { DateTime::Moment->new( year => 10, month => 2, day => 12.4 ) },
    qr/an integer/,
...
like(
    exception {
        DateTime::Moment->new( year => 10, month => 2, day => 12, hour => 4.1 );
    },
    qr/an integer/,
...
like(
    exception {
        DateTime::Moment->new( year => 10, month => 2, day => 12 )->today;
    },
...
like(
    exception {
        DateTime::Moment->new( year => 10, month => 2, day => 12 )->now;
    },
    qr/called with reference/,
